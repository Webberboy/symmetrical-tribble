...
DO $$
BEGIN
    IF NOT table_exists('mobile_deposits') THEN
...
DO $$
BEGIN
    IF NOT table_exists('budget_transactions') THEN
...
BEGIN
    IF NOT table_exists('bills') THEN
        CREATE TABLE public.bills (
            ...
            auto_pay_account_id UUID REFERENCES public.accounts(id) ON DELETE SET NULL,
