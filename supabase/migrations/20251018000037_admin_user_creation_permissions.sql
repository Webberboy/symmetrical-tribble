-- Grant admin service role permission to create users via admin API
-- This allows admin users to create new user accounts through the admin panel

-- Grant service role permission to use auth schema
