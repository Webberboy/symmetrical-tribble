...
-- INSERT INTO public.profiles (id, full_name, first_name, last_name, email, account_number, balance, account_status) 
-- VALUES 
-- ('00000000-0000-0000-0000-000000000000', 'Test User', 'Test', 'User', 'test@example.com', '4012500000001', 1000.00, 'active')
-- ON CONFLICT (id) DO NOTHING;

-- INSERT INTO public.accounts (user_id, account_number, account_type, account_name, balance, available_balance) 
-- VALUES 
-- ('00000000-0000-0000-0000-000000000000', '4012500000001', 'checking', 'Primary Checking', 1000.00, 1000.00),
-- ('00000000-0000-0000-0000-000000000000', '4012500000002', 'savings', 'Primary Savings', 5000.00, 5000.00)
-- ON CONFLICT (account_number) DO NOTHING;

-- INSERT INTO public.notifications (user_id, title, message, type) 
-- VALUES 
-- ('00000000-0000-0000-0000-000000000000', 'Welcome!', 'Welcome to your dashboard', 'success'),
-- ('00000000-0000-0000-0000-000000000000', 'Account Update', 'Your account has been updated', 'info')
-- ON CONFLICT DO NOTHING;

-- INSERT INTO public.user_notifications (user_id, title, message, type, display_as) 
-- VALUES 
-- ('00000000-0000-0000-0000-000000000000', 'System Maintenance', 'System will be under maintenance tonight', 'warning', 'banner'),
-- ('00000000-0000-0000-0000-000000000000', 'New Feature', 'Check out our new mobile app', 'info', 'card')
-- ON CONFLICT DO NOTHING;